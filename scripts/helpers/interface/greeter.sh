...
# TODO: Cant change if other greeter is enabled:
# TODO: Failed to enable unit: File /etc/systemd/system/display-manager.service already exists and is a symlink to /usr/lib/systemd/system/sddm.service.
