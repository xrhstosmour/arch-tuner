...
MISE_SCRIPT_DIRECTORY=$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)
...
source "$MISE_SCRIPT_DIRECTORY/../../../helpers/functions/ui.sh"

log_info "Installing programming languages via version manager..."
